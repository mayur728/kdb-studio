...
public class KTest {
    ...
    public void testKDoubleVector() {
        ...
        assertEquals("0.5 0.3333333 0.25 0.2 0.1666667f", vector.toString());
    ...
    private void check(K.KBase base, String expectedNoType, String expectedWithType) {
        ...
        assertEquals("Test to show type", expectedWithType, actualWithType);
    }
    ...
    public void testListToString() throws Exception {
        ...
        check(vector(K.KList.class, new K.KLong(10), new K.KInteger(10), vector(K.KList.class, new K.KDouble(1.1))), "(10;10;enlist 1.1)", "(10j;10i;enlist 1.1f)");
    }
    ...
    public void testOtherToString() throws Exception {
        ...
        //output from +/:[1;]
        check(new K.Projection((K.KList)vector(K.KList.class, new K.FEachRight(new K.BinaryPrimitive(1)), new K.KLong(1), new K.UnaryPrimitive(-1)  ) ),"+/:[1;]", "+/:[1j;]");
        //output from enlist[1;]
        check(new K.Projection((K.KList)vector(K.KList.class, new K.UnaryPrimitive(41), new K.KLong(1), new K.UnaryPrimitive(-1)  ) ),"enlist[1;]", "enlist[1j;]");
    }
