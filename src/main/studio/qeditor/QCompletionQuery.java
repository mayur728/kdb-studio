...
public class QCompletionQuery implements CompletionQuery {
            ...
            if (component instanceof JEditorPane) {
                ...
                if (s != null) {
                    ...
                    try {
                        ...
                        if (text.endsWith(".")) {
                            c.k(new K.KCharacterVector(
                                "cols " + text.substring(0, text.length() - 1)));
                            ...
                            if (res instanceof K.KSymbolVector) {
                                ...
                                for (int i = 0; i < tables.getLength(); i++) {
                                    result.add(
                                        new BooleanAttribItem(((K.KSymbol) tables.at(i)).s, offset,
                                            0, false));
                                }

                                currentIcon = Util.COLUMN_ICON;

                                r = new CompletionQuery.DefaultResult(component, "Columns", result,
                                    offset, 0);
                            }
                        } else {
                            ...
                            if (res instanceof K.KSymbolVector) {
                                ...
                                r = new CompletionQuery.DefaultResult(component, "Tables", result,
                                    offset, 0);
                            }
                        }
                    } catch (Throwable th) {
    ...
    private abstract static class QResultItem implements CompletionQuery.ResultItem {
