...
public class QSyntax extends Syntax {
    ...
    private void initMap() {
        ...
        String[] keywords = new String[]
            {
                "bin", "asin", "atan", "exit", "prd", "prior", "setenv", "tan", "wj", "wj1", "wsum",
                "ej", "aj0", "insert", "acos", "exp", "wavg", "avgs", "log", "sin", "cos", "sqrt",
                "exec", "abs", "neg", "not", "null", "floor", "string", "reciprocal", "ceiling",
                "signum", "div", "mod", "xbar", "xlog", "and", "or", "each", "mmu", "lsq", "inv",
                "md5", "ltime", "gtime", "count", "first", "var", "dev", "med", "cov", "cor", "all",
                "any", "rand", "sums", "prds", "mins", "maxs", "fills", "deltas", "ratios",
                "differ", "prev", "next", "rank", "reverse", "iasc", "idesc", "asc", "desc", "msum",
                "mcount", "mavg", "mdev", "xrank", "mmin", "mmax", "xprev", "rotate", "list",
                "distinct", "group", "where", "flip", "type", "key", "til", "get", "value", "attr",
                "cut", "set", "upsert", "raze", "union", "inter", "except", "cross", "ss", "sv",
                "vs", "sublist", "read0", "read1", "hopen", "hclose", "hdel", "hsym", "hcount",
                "peach", "system", "ltrim", "rtrim", "trim", "lower", "upper", "ssr", "view",
                "tables", "views", "cols", "xcols", "keys", "xkey", "xcol", "xasc", "xdesc",
                "fkeys", "meta", "uj", "ij", "lj", "pj", "aj", "asof", "fby", "ungroup", "xgroup",
                "plist", "enlist", "txf", "save", "load", "rsave", "rload", "show", "csv", "parse",
                "eval", "over", "scan", "select", "from", "where", "within", "update", "in",
                "delete", "sum", "avg", "min", "max", "like", "last", "by", "do", "while", "if",
                "getenv", "xexp"
            };
                ...
                if (e.state == state) {
                    ...
                    if (found) {
                        ...
                        if ((e.action == ACTION_MATCHANDPUTBACK) ||
                            (e.action == ACTION_MATCHANDCONSUME)) {
                            if (e.action == ACTION_MATCHANDPUTBACK) {
                                offset--;
                            }
    ...
    public static final Entry[] ENTRIES = new Entry[]
        {
            ...
            new Entry(INIT, "\n".toCharArray(), 30, QTokenContext.WHITESPACE,
                ACTION_MATCHANDCONSUME),
            new Entry(INIT, "\t ".toCharArray(), 5, QTokenContext.WHITESPACE,
                ACTION_MATCHANDCONSUME),
            ...
            new Entry(6, "\n".toCharArray(), INIT, QTokenContext.EOL_COMMENT,
                ACTION_MATCHANDPUTBACK),
            ...
            new Entry(9, "\"".toCharArray(), INIT, QTokenContext.CHAR_VECTOR,
                ACTION_MATCHANDCONSUME),
            ...
            new Entry(38, "\n \t".toCharArray(), INIT, QTokenContext.COMMAND,
                ACTION_MATCHANDPUTBACK),
    ...
    public QSyntax() {
        initMap();
        tokenContextPath = QTokenContext.CONTEXT_PATH;
    }
}
